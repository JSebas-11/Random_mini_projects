...
def sort() -> None:
    try:
        ...
        for element in elements:
            ...
            #En caso de encontrar carpeta se pasara al siguiente elemento 
        ...
        #Si solo hay carpetas se lanza excepcion
        if moved_files == 0 and directories >= 1:
    ...
    #Si todo salio bien mostrar mensaje al usuario
        ...
        status_label.configure(text=f"{moved_files} files moved successfully", text_color="#15f229", font=font_tuple)
